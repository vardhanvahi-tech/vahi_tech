...
export default function ProjectCard({ project }: ProjectCardProps) {
  return (
    <Link href={`/projects/${project.id}`} className="block h-full group">
      <div className="relative overflow-hidden rounded-2xl bg-white shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 h-full flex flex-col border border-gray-200">
...
function getCategoryColor(category: IProject['category']): string {
  const colors = {
    ...
    'Custom Web': 'bg-orange-100 text-orange-800',
  };
